...
def customTrainDataloader(args):
    print("getting data from  %s" % (args.data_dir))
    ...
    if args.concat_data:
        print('****** concatenating data from both datasets ******')
        print("getting data from %s" % (args.data_dir2))
